...
//        navigationController?.navigationBar.tintColor = .white
        catalogTableView.tableFooterView = UIView(frame: CGRect.zero)
        
        fetchCatalog()
    }
    
    func fetchCatalog() -> Void {
...
//        tapGestureRecognizer.obj = aSection.subjects[indexPath.row]
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let headerView = Bundle.main.loadNibNamed("CatalogHeaderCell", owner: self, options: nil)?.first as! CatalogHeaderCell
    ...
    func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        let footerView = Bundle.main.loadNibNamed("CatalogFooterCell", owner: self, options: nil)?.first as! CatalogFooterCell
